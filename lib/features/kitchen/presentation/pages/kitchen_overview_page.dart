...
class KitchenOverviewPage extends StatelessWidget {
  const KitchenOverviewPage({super.key});
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: const _KitchenOverviewView(),
    );
  }
}

class _KitchenOverviewView extends StatelessWidget {
  const _KitchenOverviewView();
        ...
        child: InkWell(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color:
                  isActive ? primaryGradientStart : Colors.white,
              borderRadius: BorderRadius.circular(12),
              boxShadow: [
                BoxShadow(
                  color: isActive
  ...
  Widget _buildBody(BuildContext context) {
    return BlocConsumer<KitchenBloc, KitchenState>(
      ...
      builder: (context, state) {
        ...
        if (state.status == KitchenStatus.success &&
            groups.isEmpty) {
